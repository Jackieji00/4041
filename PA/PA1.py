...
def hack_bank(account_list):
    ...
    if len(account_list) >= 2:
        ...
        for i in range(len(account_list)):
            if account_list[i].balance>account_list[max].balance:
                max = i
            if account_list[i].balance<account_list[min].balance:
                min = i
        account_list[max].balance -= 1337
        account_list[min].balance += 1337
